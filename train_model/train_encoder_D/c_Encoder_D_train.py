...
from train_model.train_encoder_D.b_Encoder_D_Net import AutoEncoder
...
train_D_loader = DataLoader(a_Encoder_D_dataset.train_D_set, batch_size = 2048, shuffle = True)
...
def Get_ACC():
    test_D_loader = DataLoader(a_Encoder_D_dataset.test_D_set, batch_size = 1024, shuffle = True)
    loss_f = nn.MSELoss()
    loss_sum = 0.0
    cnt = 0
